...
% if(mobilityPlayer > mobilityOpponent)
%     mobility = (100.0 * mobilityPlayer)/ mobilityPlayer + mobilityOpponent);
% elseif(mobilityPlayer < mobilityOpponent)
%     mobility = -(100.0 * mobilityOpponent)/(mobilityPlayer + mobilityOpponent);
% else
%     mobility = 0;
% end    
end
