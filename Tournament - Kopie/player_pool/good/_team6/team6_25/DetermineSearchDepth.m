...
if number_of_turns >= 24 && number_of_turns < 25
    depth = 6;
end

%% Midgame
if time_left > 90
    if number_of_turns >= 25 && number_of_turns < 45
        depth = 7;
    end
...
elseif time_left <= 90 && time_left > 60 && number_of_turns >= 25 && number_of_turns < 49
    depth = 7;
elseif time_left <= 60 && number_of_turns >= 25 && number_of_turns < 49
    depth = 6;
end
