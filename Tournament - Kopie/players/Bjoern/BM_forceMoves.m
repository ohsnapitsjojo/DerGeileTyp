function [ move] = BM_forceMoves( b, color, possible)
    ...
    try
        ...
        % Force Corners
            ...
            if nMoves > 1
                ...
                for idx = 1:nMoves
                    nStable(idx) = BM_getnStable(simulateMove(b,color,move(idx)),color);
                end
        ...
        % Avoid Close Corners
            ...
            nStable = zeros(1,nMoves);
            for idx = 1:nMoves
                nStable(idx) = BM_getHeuristic(simulateMove(b,color,move(idx)),[0 1 0 1],color);
